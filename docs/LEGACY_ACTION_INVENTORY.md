...
1. Complete `MessageList` and `Message` parity: large-mailbox list limiting,
   precise legacy sort edge semantics, remaining message/header details, and
   detailed new-message notification payloads.
