...
| `Folders` | `dev/Model/FolderCollection.js` | compat-known | Main folder-list loading action. Native parity still needs LIST/LSUB, namespaces, quota, capabilities, hidden-unsubscribed filtering, status metadata, and account-local checkable decoration. |
